...
void initSDL()
{
    ...
    bulletTexture 		= IMG_LoadTexture(game.renderer,"res/image14.png");
	enemyTexture 		= IMG_LoadTexture(game.renderer,"res/drone_1_red (1).png");
    alienBulletTexture 	= IMG_LoadTexture(game.renderer,"res/image17.png");
	...
	missileTexture		= IMG_LoadTexture(game.renderer,"res/rocket animated.png");
